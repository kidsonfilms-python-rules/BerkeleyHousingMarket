...
const MAX_EVIDENCE_CHARS = 4 * 1024 * 1024;
...
async function auth(action, id, address, timestamp, signature) {
  if (!/^\d+$/.test(String(id))) throw new Error("invalid dispute ID");
